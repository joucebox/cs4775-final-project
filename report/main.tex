...
Results demonstrate that relative rankings (MEA vs.\ Viterbi, and among MEA weighting schemes) are stable across parameter resamples, with confidence intervals overlapping minimal offsets. This indicates that our conclusions are robust to parameter estimation variance and not artifacts of overfitting to a particular subset of families.
